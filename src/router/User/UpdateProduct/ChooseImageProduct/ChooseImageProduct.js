            ...
            <div className="choose-image-product-wrapper">
              ...
              <div className="image">
                ...
                <ul className="image-wrapper">
                  ...
                  <li>
                    {!!imgProduct?.img1 && imgProduct?.img1 !== "" ? (
                  ...
                  <li>
                    {!!imgProduct?.img2 && imgProduct?.img2 !== "" ? (
                  ...
                  <li>
                    {!!imgProduct?.img3 && imgProduct.img3 != "" ? (
                  ...
                  <li>
                    {!!imgProduct?.img4 && imgProduct.img4 !== "" ? (
                  ...
                  <li>
                    {!!imgProduct?.img5 && imgProduct.img5 !== "" ? (
